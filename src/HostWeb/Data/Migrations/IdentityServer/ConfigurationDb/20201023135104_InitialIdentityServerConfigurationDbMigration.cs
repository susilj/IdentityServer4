...
namespace HostWeb.Data.Migrations.IdentityServer.ConfigurationDb
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApiResources_AspNetTenants_TenantId",
                        column: x => x.TenantId,
            ...
            //        table.ForeignKey(
            //            name: "FK_ApplicationUser_AspNetTenants_TenantId",
            //            column: x => x.TenantId,
            //            principalTable: "AspNetTenants",
            //            principalColumn: "Id",
            //            onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clients_AspNetTenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AspNetTenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IdentityResources_AspNetTenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AspNetTenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiResources_Name_TenantId",
                table: "ApiResources",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_ClientId_TenantId",
                table: "Clients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdentityResources_Name_TenantId",
                table: "IdentityResources",
                columns: new[] { "Name", "TenantId" },
                unique: true);
        }
