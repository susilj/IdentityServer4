        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rule = table.Column<string>(maxLength: 100, nullable: true),
                    RuleValidationFailureDescription = table.Column<string>(maxLength: 200, nullable: true),
                    UserEditable = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    ValueType = table.Column<int>(maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetClaimTypes_Name",
                table: "AspNetClaimTypes",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AspNetClaimTypes_NormalizedName",
                table: "AspNetClaimTypes",
